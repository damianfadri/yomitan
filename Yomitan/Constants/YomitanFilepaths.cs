...
namespace Yomitan.Constants
{
    public static class YomitanFilepaths
    {
        ...
        public static readonly string DebugDirectoryPath = Path.Combine(YomitanDirectoryPath, "Debug");
        ...
        public static readonly string CroppedImageFilePath = Path.Combine(DebugDirectoryPath, "cropped.png");
